...
const D: Dict = {
  ...
  notifEmpty: { en: "No notifications in the last 14 days", zh: "近 14 天没有通知" },
  notifAllQuiet: { en: "all quiet", zh: "一切正常" },
  notifClientsQuiet: { en: "clients all quiet", zh: "家一切正常" },
  notifSyncFailed: { en: "Sync failed", zh: "同步失败" },
  notifKpiMirror: { en: "KPI mirror issue", zh: "KPI 镜像异常" },
  notifCplSpike: { en: "CPL spiked to", zh: "CPL 飙升至" },
  notifBaseline: { en: "30-day avg", zh: "30 天均值" },
  notifQuarantine: { en: "quarantined rows", zh: "隔离区新增" },
  notifChanges: { en: "data changes", zh: "笔数据改动" },
  sanityShowupEst: { en: "Showed Up exceeds Est.Show Up", zh: "实际出席大于预计出席" },
  sanityOrdersShowup: { en: "Orders exceed Showed Up", zh: "订单数大于实际出席" },
  sanityContactInquiry: { en: "Contact exceeds Inquiry", zh: "联系数大于询盘数" },
  sanitySalesNoOrders: { en: "Sales recorded with 0 orders", zh: "有销售额但订单为 0" },
  ...
  profileSection: { en: "Profile", zh: "个人信息" },
  photoLabel: { en: "Photo", zh: "头像" },
  uploadPhoto: { en: "Upload photo", zh: "上传头像" },
  removePhoto: { en: "Remove", zh: "移除" },
  displayName: { en: "Display name", zh: "显示名称" },
  phoneLabel: { en: "Phone (optional)", zh: "电话(选填)" },
  saveChanges: { en: "Save changes", zh: "保存修改" },
  savingLabel: { en: "Saving…", zh: "保存中…" },
  savedLabel: { en: "Saved", zh: "已保存" },
  securitySection: { en: "Security", zh: "安全" },
  ...
  passwordTooShort: { en: "Password must be at least 6 characters", zh: "密码至少 6 位" },
  passwordUpdated: { en: "Password updated", zh: "密码已更新" },
  accountSection: { en: "Account & sign-in", zh: "账号与登录" },
  signInEmail: { en: "Sign-in email", zh: "登录邮箱" },
  googleLinked: { en: "Google connected", zh: "已绑定 Google" },
  googleNotLinked: { en: "Not connected", zh: "未绑定" },
  connectGoogle: { en: "Connect Google", zh: "绑定 Google" },
  accessSection: { en: "My access", zh: "我的权限" },
  yourRole: { en: "Your role", zh: "你的角色" },
  projectsAccess: { en: "Projects you can access", zh: "你能查看的项目" },
  noProjectsAssigned: { en: "No projects assigned yet", zh: "暂无分配的项目" },
  preferencesSection: { en: "Preferences", zh: "偏好" },
  languageLabel: { en: "Language", zh: "语言" },
  themeLabel: { en: "Theme", zh: "主题" },
  roleOwnerLabel: { en: "Owner", zh: "拥有者" },
  roleManagerLabel: { en: "Manager", zh: "管理员" },
  roleViewerLabel: { en: "Viewer", zh: "查看者" },
  accountLink: { en: "Account", zh: "账户" },
  currentPassword: { en: "Current password", zh: "当前密码" },
  currentPasswordWrong: { en: "Current password is incorrect", zh: "当前密码不正确" },
  changeEmail: { en: "Change email", zh: "更换登录邮箱" },
  newEmailLabel: { en: "New email", zh: "新邮箱" },
  updateEmail: { en: "Update email", zh: "更新邮箱" },
  emailUpdated: { en: "Email updated — use it next time you sign in", zh: "邮箱已更新,下次请用新邮箱登录" },
  invalidEmail: { en: "Enter a valid email address", zh: "请输入有效的邮箱地址" },
  cancelLabel: { en: "Cancel", zh: "取消" },
  googleManaged: { en: "You sign in with Google — password and email are managed there.", zh: "你用 Google 登录,密码与邮箱由 Google 管理。" },
  emailChangeHint: { en: "Changes immediately. You'll sign in with the new email next time.", zh: "立即生效,下次用新邮箱登录。" },
  changeGoogle: { en: "Change", zh: "更换" },
  unlinkGoogle: { en: "Unlink", zh: "解绑" },
  googleUnlinked: { en: "Google account unlinked", zh: "已解绑 Google 账号" },
  googleOnlyNote: { en: "Set a password in Security first to switch", zh: "先在「安全」里设置密码才能更换" },
  setPassword: { en: "Set password", zh: "设置密码" },
  setPasswordHint: { en: "Add a password so you can also sign in without Google.", zh: "设置一个密码,这样不用 Google 也能登录。" },
  passwordSet: { en: "Password set", zh: "密码已设置" },
  googleLinkingDisabled: { en: "Google re-linking isn't enabled yet — turn on Manual Linking in Supabase to use it.", zh: "Google 换绑功能尚未启用——需先在 Supabase 后台打开「Manual Linking」开关。" },
  manageAccessNav: { en: "Manage Access", zh: "权限管理" },
  teamInvitesNav: { en: "Team & Invites", zh: "团队与邀请" },
  workspaceLabel: { en: "Workspace", zh: "工作区" },
  newClientNav: { en: "New Client", zh: "新建客户" },
};
